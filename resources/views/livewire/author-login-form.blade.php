    ...
    <form wire:submit.prevent="LoginHandler()" method="get" autocomplete="off" novalidate="">
        ...
        <div class="mb-2">
          ...
          <div class="input-group input-group-flat">
            <input type="password" class="form-control" placeholder="Your password" autocomplete="off" wire:model="password" id="password-input">
            <span class="input-group-text">
              <a href="{{ back() }}" class="link-secondary" data-bs-toggle="tooltip" aria-label="Show password" data-bs-original-title="Show password" onclick="togglePasswordVisibility()">
